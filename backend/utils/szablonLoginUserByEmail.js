...
const
    loginByEmail = (userEmail, link, userName) => {
        return {
            from: process.env.GMAIL_APP_EMAIL,
            to: userEmail,
            subject: `Logowanie konta`,
            link: "",
            html: `
    <div style="background-color: #000000; color: #ffffff; padding: 40px; font-family: 'Segoe UI', Arial, sans-serif; text-align: center;">
        
        <h2 style="color: #ffffff; margin-bottom: 20px;">Logowanie do konta ${userName}</h2>
        
        <p style="font-size: 16px; color: #dddddd; line-height: 1.6;">
            Otrzymaliśmy prośbę o zalogowanie do Twojego konta  w systemie, kliknij w link aby sie zalogowac <strong>MaxHire</strong>.
        </p>
