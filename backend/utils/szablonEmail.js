...
const mailOptionsE = {
  ...
  subject: "Instrukcja zmiany e-maila w systemie MaxHire",
  html: `
    <div style="background-color: #000000; color: #ffffff; padding: 40px; font-family: 'Segoe UI', Arial, sans-serif; text-align: center;">
        
        <h2 style="color: #ffffff; margin-bottom: 20px;">Zmiana e-maila</h2>
        
        <p style="font-size: 16px; color: #dddddd; line-height: 1.6;">
            Otrzymaliśmy prośbę o zmianie e-maila do Twojego konta  w systemie <strong>MaxHire</strong>.
        </p>
